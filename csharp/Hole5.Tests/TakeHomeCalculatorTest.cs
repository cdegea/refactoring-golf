...
namespace Hole5.Tests
{
    public class TakeHomeCalculatorTest
    {
        ...
        {
            int first = new TakeHomeCalculator(new TaxRate(new TaxRate(new TaxRate(10)))).NetAmount(Money.Create(40, "GBP"),
                Money.Create(50, "GBP"),
        ...
        {
            Assert.Throws<Incalculable>(() => new TakeHomeCalculator(new TaxRate(new TaxRate(new TaxRate(10)))).NetAmount(
